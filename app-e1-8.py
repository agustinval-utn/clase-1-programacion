...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        numeros1 = self.txt_operador_a.get()
        numero1 = int(numeros1)
        numeros2 = self.txt_operador_b.get()
        numero2 = int(numeros2)
        resultado = numero1 + numero2
        texto = f"el resultado de sumar " + numeros1 + " con " + numeros2 + f" es {resultado}"
        alert("ganamos", texto)
